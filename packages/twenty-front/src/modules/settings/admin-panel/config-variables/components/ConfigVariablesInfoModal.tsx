...
export const ConfigVariablesInfoModal = () => {
  ...
  return (
    <Modal modalId={CONFIG_VARIABLES_INFO_MODAL_ID} isClosable size="medium">
      <Modal.Header>
      ...
      <StyledModalContent>
        <ContentContainer>
          <StyledSection>
            <StyledTitle>1. {t`Admin Panel (Global Defaults)`} 🌍</StyledTitle>
            <StyledText>
            ...
            <StyledText>
              ...
              {t`If a Workspace has NOT configured its own Advanced Settings, the system will fall back to reading these values.`}
            </StyledText>
          </StyledSection>
          ...
          <StyledSection>
            ...
            <StyledText>
              <strong>{t`Scope:`}</strong>{' '}
              {t`These settings affect ONLY the current Workspace.`}
            </StyledText>
          </StyledSection>
          ...
          <StyledSection>
            ...
            <StyledExample>
              ...
              >
                <div>
                  <StyledText>
                    <strong>{t`Workspace 1`}</strong>{' '}
                    <span style={{ opacity: 0.7 }}>
                      ({t`No advanced settings`})
                    </span>
                  </StyledText>
                  <StyledText>👉 {t`Uses 'Client-A' for login.`}</StyledText>
                </div>
                <div style={{ marginTop: '4px' }}>
                  <StyledText>
                    <strong>{t`Workspace 2`}</strong>{' '}
                    <span style={{ opacity: 0.7 }}>
                      ({t`Filled 'Client-B' in Advanced Settings`})
                    </span>
                  </StyledText>
                  <StyledText>👉 {t`Uses 'Client-B' for login.`}</StyledText>
                </div>
              </div>
