...
echo "   cd docker/dev-flow/local_build_for_mac && ./build_all_services_prod_env.sh"
echo "   如果需要清理 workspace metadata，请使用以下命令："
echo "   AUTO_CLEAN_ORPHAN_VIEWS=true ./build_all_services_prod_env.sh"
